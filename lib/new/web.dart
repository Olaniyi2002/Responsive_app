        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                  height: height * 0.89,
                  width: width >= 913 ?width / 1.8:width/1,
                  color: Colors.white,
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            SizedBox(
                              height: height / 3.5,
                              width:width>=913?width / 1.8:width,
                              child: SingleChildScrollView(
                                ...
                                child: Row(
                                  ...
                                  children: const [
                                    ...
                                    Containpix(
                                        name: "Ella Olusegun",
                                        image: "lib/images/profile/post1.jpg",
                                        profile: "lib/images/profile/image2.jpg"),
                                    Containpix(
                                        name: "Solomon Abuh",
                                        image: "lib/images/profile/post2.jpg",
                                        profile: "lib/images/profile/image3.png"),
                                    Containpix(
                                        name: "Adeh Fiyin",
                                        image: "lib/images/profile/post3.jpg",
                                        profile: "lib/images/profile/image4.jpeg"),
                                    Containpix(
                                        name: "Babablola Tobi",
                                        image: "lib/images/profile/post4.jpg",
                            ...
                            Container(
                              ...
                              height: height / 15,
                              width: width>=913?width / 2.5:width/1.3,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    width >= 1080
                                        ? "Henris and 9 other joined the group"
                                        : "Henris and 9 other\n joined the group",
                                    style: TextStyle(
                                        fontSize: width >= 1080
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        height: height / 3.5,
        width: width>=913?width / 10:width/5,
        decoration: BoxDecoration(
...
class Contact extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Text(
        name,
        style: TextStyle(fontSize: width >= 957 ? 16 : 12),
      ),
    );
  }
}
